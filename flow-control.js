...
function ageChecker(age) {if (age>12 && age<20) {return 'You are a teenager!'} else if (age>19) {return 'You are a grownup'} else if (age<13) {return 'You are a kid'}


}

function ternaryTeenager(age) {if (age>12 && age<20) {return ('You are a teenager')} else {return ('You are not a teenager')}
