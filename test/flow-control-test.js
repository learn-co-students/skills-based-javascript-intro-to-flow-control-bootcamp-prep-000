...
describe('flow-control', () => {
  ...
  describe('basicTeenager', () => {
    if('should return "You are a teenager!" if the age is between 13-19', () => {
  ...
  describe('teenager', () => {
    ...
    if('should return "you are not a teenager" if the age is not between 13-19', () => {
  ...
  describe('ageChecker', () => {
    ...
    if('should return "You are a kid" if the age is 12 or below', () => {
      expect(ageChecker(12)).toEqual("You are a kid")
    })

    if('should return "You are a grownup" if the age is 20 or above', () => {
      expect(ageChecker(29)).toEqual("You are a grownup")
    })
  })

  describe('ternaryTeenager', () => {
    if('should return "You are a teenager" if age is between 13-19', () => {
      expect(ternaryTeenager(15)).toEqual("You are a teenager")
    })

    if('should return "You are not a teenager" if age not between 13-19', () => {
